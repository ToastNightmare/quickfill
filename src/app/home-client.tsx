      ...
      <section className="relative overflow-hidden bg-navy px-4 py-20 sm:px-6 sm:py-24 lg:px-8">
        ...
        <div className="relative mx-auto max-w-4xl text-center">
          ...
          <div className="mt-8 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
            <Link
              href="/editor"
              className="flex h-12 w-full items-center justify-center gap-2 rounded-xl bg-accent px-8 text-base font-semibold text-white shadow-lg shadow-accent/25 hover:bg-accent-hover transition-colors outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-navy sm:w-auto"
            >
              Open Editor
            ...
            <Link
              href="/dashboard"
              className="flex h-12 w-full items-center justify-center rounded-xl border border-white/20 px-6 text-base font-semibold text-white hover:bg-white/10 transition-colors outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-navy sm:w-auto"
            >
              View Dashboard
            </Link>
          </div>
...
function HomeFooter({ signedIn }: { signedIn: boolean }) {
  return (
...
const steps = [
  { number: "1", title: "Upload", description: "Upload a PDF or take a photo of a paper form" },
  { number: "2", title: "Fill", description: "Clean it up, fill it in, and sign right on the document" },
  { number: "3", title: "Download", description: "Preview and download your finished PDF" },
];
...
export default function Home() {
  ...
  return (
    <div className="flex flex-col">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            operatingSystem: "Any",
            description:
              "Fill any PDF form online. Upload a PDF or a photo of a paper form, fill it with text, signatures, checkboxes, and dates, then preview and download your completed document. No software required.",
            featureList: [
              "PDF form filling",
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            mainEntity: [
              {
                "@type": "Question",
                name: "Is QuickFill free to use?",
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "You can upload, fill, sign and preview your document for free, without a credit card. When it's ready, choose a download option to unlock the clean finished file.",
                },
              },
              {
                "@type": "Question",
              ...
              },
              {
                ...
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "Yes. QuickFill works on iPhone, Android, iPad, or any device with a web browser.",
                },
              },
              {
                "@type": "Question",
                name: "Can I use it for government forms?",
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "Yes. QuickFill works with any PDF form and includes ready-made government templates: TFN declarations, Centrelink income forms, Medicare enrolment, NDIS service agreements, and more.",
                },
              },
              {
                "@type": "Question",
                name: "When do I see download options?",
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "After you finish editing and choose Download, QuickFill shows the right next step for your document.",
                },
              },
            ],
          }),
      ...
      <section className="relative overflow-hidden bg-navy px-4 py-16 sm:px-6 sm:py-20 lg:px-8">
        <div className="relative mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-gray-300 sm:text-xl">
            Upload a PDF or take a photo of a paper form. Clean it up, fill it, sign it, and finish it without printing.
          </p>
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="mt-8 flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
            <Link
              ...
              className="flex h-11 w-full items-center justify-center gap-2 rounded-lg bg-accent px-5 text-sm font-semibold text-white hover:bg-accent-hover transition-colors outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:ring-offset-surface sm:w-auto"
            >
              Upload a PDF
              <ArrowRight className="h-4 w-4" />
            </Link>
            <Link
              href="/privacy"
              className="flex h-11 w-full items-center justify-center rounded-lg border border-border px-5 text-sm font-semibold text-text hover:bg-surface-alt transition-colors outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:ring-offset-surface sm:w-auto"
            >
        ...
        <div className="mx-auto max-w-2xl">
          ...
          <div className="mt-12 space-y-6">
            <div className="rounded-xl border border-border bg-surface-alt p-6">
              <h3 className="font-semibold text-base">Is QuickFill free to use?</h3>
              <p className="mt-2 text-sm text-text-muted">You can upload, fill, sign and preview your document for free, without a credit card. When it&apos;s ready, choose a download option to unlock the clean finished file.</p>
            </div>
            <div className="rounded-xl border border-border bg-surface-alt p-6">
      ...
      {/* Footer */}
      <HomeFooter signedIn={Boolean(isLoaded && isSignedIn)} />
    </div>
  );
}
