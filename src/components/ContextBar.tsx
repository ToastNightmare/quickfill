...
import { Type, CheckSquare, PenTool, Calendar, X, Trash2, Minus, Plus, MousePointer2, Eraser, SquareSplitHorizontal } from "lucide-react";
    ...
    if (fieldType === "comb") {
      ...
      return (
        <Bar>
          ...
          <span className="text-sm font-semibold text-text">Box Field</span>
          <div className="w-px h-4 bg-border" />
