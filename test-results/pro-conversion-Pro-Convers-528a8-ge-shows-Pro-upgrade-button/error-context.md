...
- Name: pro-conversion.spec.ts >> Pro Conversion Features >> Pricing page shows Pro upgrade button
- Location: tests/pro-conversion.spec.ts:9:7

# Error details

```
Error: page.goto: net::ERR_NETWORK_CHANGED at https://getquickfill.com/pricing
Call log:
  - navigating to "https://getquickfill.com/pricing", waiting until "load"
